...
public class Favorite extends Model
{
    ...
    /**
     * Updates Favorite table, calls super updateModel() to perform needed task
     *               <column, value>
    ...
    /**
     * Deletes a Favorite instance based on the id, calls super deleteModel() to perform needed task
     * @return Favorite
     */
